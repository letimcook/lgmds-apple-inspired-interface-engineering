...
```bash
npx skills add OWNER/lgmds-apple-inspired-interface-engineering
```

```bash
npx skills add https://github.com/OWNER/lgmds-apple-inspired-interface-engineering
```

Replace `OWNER` with this repository's GitHub owner/organization. For a local copy of the folder instead:
